                ...
                if (sclk_cnt == SCLK_DIV-1) begin
                    ...
                    if (sclk_phase == 1'b0) begin
                        ...
                        if (bit_cnt == 4'd7) begin
                            // rx_shift already holds all 8 rising-edge samples
                            // (S0..S7, S0=MSB). The old {rx_shift[6:0],ldc_sdo}
                            // dropped the MSB and appended a spurious 9th sample
                            // -> read D4 as D4<<1 = A8. Capture rx_shift as-is.
                            spi_rx_byte <= rx_shift;
                            spi_state   <= SPI_END;
                        end else begin

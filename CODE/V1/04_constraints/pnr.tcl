# Full place-and-route + 27 MHz timing closure check (ttcgs_pnr harness) on GW1NR-9C
...
add_file -type verilog ttcgs_pnr.v
add_file -type sdc inausis.sdc

set_option -top_module ttcgs_pnr
